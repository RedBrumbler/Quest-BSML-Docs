...
`<vertical pref-width='60' pref-height='30' bg='round-rect-panel' vertical-fit='PreferredSize'>
    <text text='Click to reload textures:' align='Center'/>
    <stack pref-width='10' pref-height='10' vertical-fit='PreferredSize' horizontal-fit='PreferredSize'>
...
`<bg size-delta-x="65" size-delta-y="65" anchor-pos-x="0" anchor-pos-y="10">
    <vertical horizontal-fit='PreferredSize' vertical-fit='PreferredSize' anchor-pos-x='-3' size-delta-y='0'>
...
export const List = {
    exampleString: 
`<bg size-delta-x="65" size-delta-y="65" anchor-pos-x="0" anchor-pos-y="10">
    <vertical bg='round-rect-panel' horizontal-fit='PreferredSize' vertical-fit='PreferredSize' anchor-pos-x='-3' size-delta-y='0' pad='2'>
...
`<vertical pref-width='60' pref-height='30' bg='round-rect-panel' vertical-fit='PreferredSize' pad='2'>
    ...
    <modal id='myModal' pref-height='10' pref-width='30' click-off-closes='true' move-to-center='false' anchor-pos-x='-40' anchor-pos-y='20'>
        <vertical pref-width='40' pref-height='20' bg='round-rect-panel' vertical-fit='PreferredSize' pad='2'>
...
export const ModifierContainer = {
    exampleString: 
`<modifier-container label='Custom Modifier' on-chang='ModifierToggled' pref-width='80' pref-height='50' size-delta-x='89'>
    <grid bg='round-rect-panel' cell-size-x='25' spacing-x='2' cell-size-y='10' spacing-y='2' pref-width='80' pref-height='50' pad='2'>
...
export const RawImage = {
    exampleString: 
`<vertical pref-width='60' pref-height='30' bg='round-rect-panel' vertical-fit='PreferredSize' pad='2'>
    <stack pref-width='10' pref-height='10' horizontal-fit='PreferredSize' vertical-fit='PreferredSize'>
...
`<vertical pref-width='60' pref-height='30' bg='round-rect-panel' vertical-fit='PreferredSize' pad='2'>
    <stack pref-width='60' pref-height='30'>
        <image src='#ClockIcon' img-color='#ff0000' preserve-aspect='true' skew='0.18'/>
...
export const Text = {
    exampleString: 
`<vertical pref-width='60' pref-height='50' bg='round-rect-panel' vertical-fit='PreferredSize' pad='2'>
