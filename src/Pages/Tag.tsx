            ...
            <div className='main-content'>
                ...
                { example != null ? 
                    <div className='usage-example'>
                        ...
                        {example.exampleImage != null ? <div className='example-image-wrapper'><img className='example-image' src={process.env.PUBLIC_URL + '/img/' + example.exampleImage} alt={docTag.name + ' In Game Result'}/></div> : <></>}
                    </div>
                    : <></>
                }
